 ...
 * "@(#) $Id: ACMM:2dFCanTask/2dfcantask.c,v 1.1 26-Mar-2018 08:48:13+10 ks $"
 ...
 * RCS id
 */
static const char *rcsId="@(#) $Id: ACMM:2dFCanTask/2dfcantask.c,v 1.1 26-Mar-2018 08:48:13+10 ks $";
